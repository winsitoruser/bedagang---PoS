...
const useFormField = () => {
  ...
  // If no form context is available, return a fallback field state
  if (!form) {
    // This provides basic functionality when no form is present
  ...
  if (!fieldContext) {
    // Handle missing field context with fallback
    const id = itemContext?.id || fallbackId
    return {
      id,
      name: '',
